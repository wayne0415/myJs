function Sdata(no, name, scoreHtml, scoreCss, scoreJs, ...other) {
    // this代表物件本身
    this.sid = no;
    this.sName = name;
    this.html = scoreHtml;
    ...
    this.showData = function () {
        ...
        console.log(`身高: ${other[0]}, 體重: ${other[1]}`);
    };
}
// 2. 建立物件樣板
// 傳值給物件樣板參數
let s1 = new Sdata("s001", "王小明", 100, 100, 100, 157, 50);
// 呼叫物件樣板中的方法
s1.showData();

let s2 = new Sdata("s002", "陳小美", 25, 54, 68, "沒有身高", 100);
s2.showData();

let s3 = new Sdata("s003", "老王", 28, 44, 60, "沒有身高", "沒有體重");
s3.showData();
